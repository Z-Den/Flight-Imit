...
public class PlaneController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _planeCrash;
    [SerializeField] private GameObject _planeSmoke;
    [SerializeField] private GameObject _crushText;
    ...
    private void CalculateAngleOfAttack()
    {
        ...
        _isStalled = Mathf.Abs(_angleOfAttack * Mathf.Rad2Deg) > _stallAngle;

        Debug.Log($"Velocity: {_currentLocalVelocity}, AoA: {_angleOfAttack * Mathf.Rad2Deg}°, IsStalled: {_isStalled}");
    }
    ...
    private void Die()
    {
        _throttle = 0;
        _isDestroyed = true;
        _planeCrash.SetActive(true);
        _planeSmoke.SetActive(true);
        _crushText.SetActive(true);
